  ...
  <section className="px-4" aria-labelledby="intro-homepage-section">
    <div className="flex min-h-screen w-full flex-col items-center justify-center">
      <div className="max-w-3xl font-light text-gray-900">
        <h2
          id="intro-homepage-section"
          className="inter-heading text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl xl:font-extralight"
        >
          Hello! I am Oxypteros.
        </h2>
        <p className="inter-heading mt-2 text-lg text-gray-700 sm:text-xl md:text-xl lg:text-2xl xl:text-3xl xl:font-extralight">
          I wrote these words; I wrote the code that renders them.
        </p>
        <div className="text-foreground mt-8 space-y-4 text-base font-normal xl:text-lg">
          <p>
